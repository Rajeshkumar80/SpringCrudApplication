...
import com.example.Product.security.JwtAuthFilter;
 ...
 * Read endpoints stay public; write endpoints on /api/products/**
 * require the ADMIN role. Auth endpoints are always public.
 */
@Configuration
@EnableWebSecurity
